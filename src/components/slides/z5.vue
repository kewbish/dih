...
export default {
  data() {
    return {
      slide: `Let's fill up our .about-me (The . denotes a class, so this would be the section with the class of about-me) with content. Inside the \`<section>\` tags, type:
