<template>
  <slide slideSubject="15: Media Queries and responsiveness" :slideContent="slide"></slide>
</template>
...
export default {
  data() {
    ...
    .grid-container {
      ...
      \nTry previewing your site now, and resizing your browser window. If all went well, the amount of columns will shift!
