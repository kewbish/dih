<template>
  <slide slideSubject="22: </lesson>" :slideContent="slide"></slide>
</template>
...
export default {
  data() {
    return {
      slide: `That's about it for this course, but it's not the end of your coding journey. We haven't gone over everything in HTML and CSS, let alone touched other languages. Some future exploring points:
      \n- CSS animations and other advanced properties
      \n- \`<iframe>\` and rich, embeddable content
      \n- an alternative Grid-like technology called Flexbox
      \nIf you'd like to investigate these terms further, check out the following resources: [Khan Academy](https://www.khanacademy.org/computing/computer-programming/html-css), [GitHub Labs](https://lab.github.com/githubtraining/introduction-to-html), and [Traversy Media](https://www.youtube.com/watch?v=UB1O30fR-EE&list=PLillGF-RfqbZTASqIqdvm1R5mLrQq79CU).
