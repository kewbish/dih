...
export default {
  data() {
    return {
      slide: `Commonly, we also see elements centered in various ways on webpages. Let's learn how to do that, applying our new knowledge with element and class selectors. (Remember, the \`h1{}\` and the \`.custom-div{}\`?)
