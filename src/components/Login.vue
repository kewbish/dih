            ...
            <div class="tile is-parent">
              <div class="tile is-child box">
                <div class="login" v-if="loginSwitch">
                  <h1 class="title is-4">
                    Login
                    <a class="switch" @click="switchLogin">or create</a>
                  </h1>
                  <div class="field">
                  ...
                  <div class="field">
                    <div class="control">
                      <button class="button" style="margin-right: 1%;" @click="loginEmail()">Log In</button>
                ...
                <div v-else-if="forgot">
                  <h1 class="title is-4">
                    Reset password
                    <a class="switch" @click="switchLogin">or login</a>
                  </h1>
                  <div class="field">
                    <label class="label">Email</label>
                    <div class="control">
                ...
                <div class="create" v-else>
                  ...
                  <div class="field">
                    <div class="control">
                      <button class="button" @click="createEmail()">Create</button>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="tile is-4 is-parent">
              <div class="tile is-child">
                <div class="box">
                  ...
                  <a class="button" style="margin-bottom:10px" @click="loginGoogle">Log In - Gmail</a>
                  <br />
...
export default {
    ...
    loginAnon() {
      ...
      if (!user) {
        firebase
          ...
          .then(() => {
            this.$router
              .push(lastRoute != null ? lastRoute : "/0")
              .catch((err) => {
        ...
        this.$router.push(lastRoute != null ? lastRoute : "/0").catch((err) => {
          console.log("There was an error.", err);
        });
      }
    },
  ...
  beforeCreate: function () {
    ...
    if (user && lastRoute) {
      this.$router
        .push(lastRoute != "undefined" || lastRoute != null ? lastRoute : "/0")
        .catch((err) => {
          console.log("There was an error.", err);
        });
    }
